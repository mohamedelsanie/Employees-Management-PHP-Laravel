...
<main>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 align-self-center">
                <h1>{{ __('front/common.error_500') }}</h1>
                <h2>{{ __('front/common.error_500_title') }}</h2>
                <p>{{ __('front/common.error_500_content') }}</p>
                <a href="{{ config('app.url') }}" class="btn green">{{ __('front/common.home') }}</a>
            </div>
        </div>
    </div>
</main>
