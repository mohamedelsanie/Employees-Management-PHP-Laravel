<x-admin-layout>
                ...
                <div class="col-md-6 col-sm-12">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('admin/admin.create.create') }}</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="clearfix mb-10">
                    <div class="pull-left">
                        <h4 class="text-blue h4">{{ __('admin/admin.create.create') }}</h4>
                    </div>
                </div>
                <div class="dropdown-divider"></div>
                <form action="{{ route('admin.admins.store') }}" method="post" class="mt-6 space-y-6">
                    @csrf
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-md-8 mb-30">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input name="name" placeholder="{{ __('admin/admin.fields.name') }}" value="{{ old('name') }}" class="border-gray-300 rounded-md shadow-sm form-control @error('name') border border-danger @enderror" type="text"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input name="email" placeholder="{{ __('admin/admin.fields.email') }}" value="{{ old('email') }}" class="border-gray-300 rounded-md shadow-sm form-control @error('email') border border-danger @enderror" type="email" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input name="password" placeholder="{{ __('admin/admin.fields.password') }}" value="{{ old('password') }}" class="border-gray-300 rounded-md shadow-sm form-control @error('password') border border-danger @enderror" type="password" />
                            ...
                            <div class="card card-box custom mb-10" id="accordionWork">
                                ...
                                <div id="collapseWork" class="card-body show" data-parent="#accordionWork" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <input name="dob" placeholder="{{ __('admin/admin.fields.dob') }}" value="{{ old('dob') }}" class="border-gray-300 rounded-md shadow-sm date-picker2 form-control @error('dob') border border-danger @enderror" type="text"/>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 col-md-12">
                                            <select name="status" class="border-gray-300 rounded-md shadow-sm custom-select col-12 @error('status') border border-danger @enderror">
                                                <option value="" @if(old('status') == '') selected @endif>{{ __('admin/admin.fields.choose') }}</option>
                                                <option value="published" @if(old('status') == 'published') selected @endif>{{ __('admin/admin.fields.published') }}</option>
                                                <option value="disabled" @if(old('status') == 'disabled') selected @endif>{{ __('admin/admin.fields.disabled') }}</option>
                                            </select>
                        ...
                        <div class="col-sm-12 col-md-10">
                            <button class="btn btn-primary bg-gray-800" type="submit">{{ __('admin/admin.fields.create') }}</button>
                        </div>
                    </div>
                </form>
    ...
    @endsection
    @section('page_title'){{ __('admin/admin.create.title_tag') }}@endsection
</x-admin-layout>
